"""
Example file for VacuumTransfer class

This example demonstrates the use of the VacuumTransfer model for pneumatic
powder transfer operations using vacuum pumps and cyclone separators.
"""
...
def main():
    ...
    print(f"  Steady-state time: ~{times[np.where(powder_rates > 0.95*powder_rates[-1])[0][0]]:.0f} s")
    print()
